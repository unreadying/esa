...
['df','<br><br><br><div class="rm" id="df"><img src="ads/m9.jpg" alt="a image of a sailboat on a stormy sea"><br><p>milk <u>read more</u></p></div>'],
...
const wdlist = 
[
['a','<div class="rm" id="a"><img src="notads/a1.jpg"><br>a new Toronto agency <u>read more</u></div>'],
...
bs:"<img src='ads/bs9.jpg' alt='a mockup of a tarot card and beside it an ad that reads : in other words : we are always sustainable'><br><p>clearing up the facts is a nessesity when your brand is built on ethical practices;<br><br>This is especially true for The Body Shop, who's recent changes in owership have left consumers perplexed about the companies values. <br> <img src='ads/bs8.jpg' alt='a mockup of a tarot card and beside it an ad that reads : in other words : we are always sustainable'><br><u>read less</u>",
df:"<img src='ads/m9.jpg' alt='an image of a sailboat on a stormy sea'><br><p>milk is a healthy and delicious beverage. <br><br> Yet in recent times, drinking milk by the glass has been on the decline. <br><br> Therfore, the goal of this ad is to re-establish milk as a wholesome liquid snack. <br><br> The comercial starts on a stormy sea <br> <img src='ads/m1.jpg'><br>The sailor is struggling to keep the boat from capsizing<br><img src='ads/m2.jpg'><br>The sailor cries out for help<br><img src='ads/m3.jpg'><img src='ads/m3text.jpg' style='max-width:50%'><br>Cut to the cow with a glass of milk<br><img src='ads/m4.jpg'><br>The sailor ties down the rigging<br><img src='ads/m5.jpg'><br>Then the sailor quickly drinks the glass of milk<br><img src='ads/m6.jpg'><br>Rejuvenated, the sailor thanks the cow<br><img src='ads/m7.jpg'><br>And they sail away<br><img src='ads/m8.jpg'>",
a:'<img src="notads/a1.jpg"><br>a new Toronto agency, <a href="https://adandad.ca">Ad&Ad</a>, needed a fresh look to break into the competetive local ad market. <br><br> Their guiding philosophy is "big business quality, with small business character". <br><br> That philosophy guided me to a visual brand that combines corporate modernity with artistic quirks. <br> <img src="notads/a2.jpg"><br><img src="notads/a3.jpg"><br><img src="notads/a4.jpg"><br><u>read less</u> ',
pr:'<img src="notads/pr3.jpg"><br>the future of computing lies in conversation and natural language; <br><br> such is the philosophy of my client <a href="https://xerelia.ca/punk">Punk Records.</a> <br><br> To visually represent their obsession with language, their interface is almost entirely text based.<img src="notads/pr2.jpg"><br>The different colors you see here are controlled by user customization, providing limitless possibilities.<img src="notads/pr4.jpg"><br><u>read less</u> ',
qq:'<img src="notads/qq1.jpg"><br>quarterly TTRPG zine, <a href="https://quarterstaff.xerelia.ca">QuarterStaff Quarterly</a>, is a publication run by a group of friends. <br><br> They were initially sharing their zine realeases via email, so i offered to make them a simple website to make sharing easier. <br> <img src="notads/qq2.jpg"><br> <u>read less</u> ',
sc:'<img src="notads/sc1.jpg"><br>picture car rentals is a niche but active industry in Toronto. <br><br> <a href="https://sashascars.ca"> Sasha\'s Cars </a>is one of a few individuals renting out classic cars for photoshoots, events and productions. <br><br> After growing his instagram and gaining some traction, Sasha commisioned me to design and program his website. <br> <img src="notads/sc2.jpg"><br> <img src="notads/sc3.jpg"><br><img src="notads/sc4.jpg"><br><u>read less</u>',
x:'<img src="notads/x1.jpg"><br>an artist portfolio serves as a sort of digital exhibition of their work. <br><br> <a href="https://xerelia.ca">xerelia</a> was designed to be a digital gallery which visitors can explore. <br><br><img src="notads/x2.jpg"><br> <img src="notads/x3.jpg"><br><img src="notads/x4.jpg"><br><img src="notads/x5.jpg"><br> <img src="notads/x6.jpg"><br> <img src="notads/x7.jpg"><br><u>read less</u>'

}

const rllist =
{yn:"<img src='ads/yn5.jpg' alt='a mockup of an ad on the subway that points to a chair and reads 'sit here if you play ps5''><br><p>sparking community <u>read more</u>",
bd:'<img src="ads/bd7.jpg" alt="a mockup of an ad at a bus stop with a spy escaping assailants through an air vent using nothing but a black and decker cordless drill"><br><p>thrilling uses for ordinary items <u>read more</u>',
ms:'<img src="ads/ms5.jpg" alt="a mockup of a billboard that reads : printed with biodegradable ink, use sustainable products -mountain sky"><br><p>conscientious advertising <u>read more</u>',
tl:'<img src="ads/tl5.jpg" alt="a mockup of an ad at a bus stop that reads : you see your past self waiting for the bus, what do you talk about?"><br><p>bringing the young and old together <u>read more</u>',
bs:'<img src="ads/bs9.jpg" alt="a mockup of a tarot card and beside it an ad that reads : in other words : we are always sustainable"><br><p>clearing up the facts <u>read more</u>',
df:'<img src="ads/m9.jpg" alt="a image of a sailboat on a stormy sea"><br><p>milk <u>read more</u></p></div>',
a:'<img src="notads/a1.jpg"><br>a new Toronto agency <u>read more</u>',
pr:'<img src="notads/pr3.jpg"><br>the future of computing <u>read more</u>',
qq:'<img src="notads/qq1.jpg"><br>quarterly TTRPG zine <u>read more</u>',
sc:'<img src="notads/sc1.jpg"><br>picture car rentals <u>read more</u>',
x:'<img src="notads/x1.jpg"><br>an artist portfolio <u>read more</u>'
}
...
function newpage(e){
	...
	if(e.target.id=="ad" || e.target.id=="mad" || e.target.id=="esa"){
		...
		cat = 'ab'
		geninfo(1,"<p><img src='notads/stover0.jpeg'><br>evan stover is a settler living on the home-land of the səlilwətaɬ (Tsleil Waututh Nation), the kʷikʷəƛ̓əm (Kwikwetlem First Nation), and the general home of the Coast Salish People . Hailing from victoria, he spent four years studying advertising at Ontario's College of Art and Design ( OCAD ), before moving to Vancouver in 2025. </p>")
		window.scrollTo(0,0);
	}if(e.target.id=="co" || e.target.id=="mco"){
		cat = 'co'
		geninfo(1,"<p class='mobh'><a href='mailto:evan@adandad.ca'><img src='notads/stover.jpg'><br></a>email : <a href='mailto:evan@adandad.ca'>evan@adandad.ca</a></p><p class='comh'><a href='mailto:evan@adandad.ca'><img src='notads/underpass.jpg'><br></a>email : <a href='mailto:evan@adandad.ca'>evan@adandad.ca</a></p>");
		window.scrollTo(0,0);
	...
	if(e.target.id=="bs"){
	genwork(e,"these advertisements represent the culmination of my research into the body shop's decline since its 2006 acquisition by l'oreal . it was an assignment given to me by my research professor ( and strategy genius ) Richard Fofana ; we were asked to pick a failing and controversial brand ( the body shop in my case ), research the controversy , create a relevant brief , and ideate a creative campaign . after conducting a survey and looking online , i made two key conclusions <br><br> 1 : customers are confused about the body shops ethicality <br><br> 2 : customers are confused about ethical brands / ethical shopping in general <br><br> my goal was clear : demystify ethical brands <br><br> with this insight , i conceptualized a campaign using tarot imagery to represent the 'mystical' world of ethics , along with sans serif text representing the 'demystified' truth about the body shop","<img src='ads/bs1.jpg'><img src='ads/bs2.jpg'><br><br><br><br><img src='ads/bs3.jpg'><img src='ads/bs4.jpg'><img src='ads/bs5.jpg'");
	}
	...
	if(e.target.id=="bd"){
	genwork(e,"if you haven't seen Micheal Bay's black & decker TV ads , id recomend clicking <a href='https://www.youtube.com/watch?v=GSJ4Y0ghUME'>here</a> or <a href='https://www.youtube.com/watch?v=z_oDvznQ5bo'>here</a> to watch them .<br><br>my black & decker ads ( mockups ) are a direct continuation of that campaign .<br><br>in order to adapt the commercials to print , i distilled the Micheal Bay ads into three key moments<br><br>the trouble ( ex : falling out of a plane )<br><br>the solution ( ex : makeshift black & decker helicopter )<br><br>the escape ( ex : safely driving away )<br><br>so to keep the tone of the campaign , i decided to create still images with all three steps depicted at once . each mockup contains a story that needs to be unraveled by the viewer ; obviously a final version would have better visuals , ideally using photography .","<img src='ads/bd2.jpg'><br><br><p>if there's no way out ... make one </p><br><img src='ads/bd4.jpg'><br><img src='ads/bd3.jpg'>");
	}
...
var html='<canvas id="canvas"></canvas><div class="controls"><p>speed <input class="slider" id = "speed" value = "5s" min = "0" max= "25" type = "range"></p><p>width <input class="slider" id = "width" value = "150" min = "0" max = "245" type = "range"></p><p>height <input class="slider" id = "height" value = "100" min = "0" max ="220" type = "range"></p><p>nodes <input class="slider" id = "nodes" value = "4" min = "0" max = "15" type = "range"></p><p>perspective <input class="slider" id = "perspective" value = "55" min = "-55" max = "55" type = "range"></p></div>'
