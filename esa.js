...
a:'<img src="notads/a1.jpg"><br>a new Toronto agency, Ad&Ad, needed a fresh look to break into the competetive local ad market. <br><br> Their guiding philosiphy is "big business quality, with local business character". <br><br> So for their visual brand, I tried to combine austeer corporate contrast, with artistic quirks. <br> <img src="notads/a2.jpg"> ',
pr:'<img src="notads/pr3.jpg"><br>the future of computing lies in conversation and natural language; <br><br> such is the philosophy of my client Punk Records. <br><br> To visually represent their obsession with language, their interface is almost entirely text based.<img src="notads/pr2.jpg"><br>The different colors you see here are controlled by user customization, providing limitless possibilities.<img src="notads/pr1.jpg"> ',
qq:'<img src="notads/qq1.jpg"><br>quarterly TTRPG zine, QuarterStaff Quarterly, is a publication run by a group of friends. <br><br> They were initially sharing their zine realeases via email, so i offered to make them a simple website to make sharing easier. ',
sc:'<img src="notads/sc1.jpg"><br>picture car rentals is a niche but active industry in Toronto. <br><br> Sasha\'s cars is one of a few individuals renting out classic cars for photoshoots, events and productions. <br><br> After growing his instagram and gaining some traction, Sasha commisioned me to design and program his website. <br> <img src="notads/sc2.jpg"><br> <img src="notads/sc3.jpg">',
x:'<img src="notads/x1.jpg"><br>an artist portfolio serves as a sort of digital exhibition of their work. <br><br> xerelia was designed to be a sort of playground in which users can explore. <br><br> by nesting work within pages and menus, it makes each visit a unique experience. <br> <img src="notads/x2.jpg">'
...
a:'<img src="notads/a1.jpg"><br>a new Toronto agency',
