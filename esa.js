...
function newpage(e){
	...
	if(e.target.id=="bd"){
	genwork(e,"if you haven't seen Micheal Bay's black & decker TV ads , id recomend clicking <a href='https://www.youtube.com/watch?v=GSJ4Y0ghUME'>here</a> or <a href='https://www.youtube.com/watch?v=z_oDvznQ5bo'>here</a> to watch them .<br><br>my black & decker ads ( mockups ) are a direct continuation of that campaign .<br><br>in order to adapt the commercials to print , i distilled the Micheal Bay ads into three key moments<br><br>the trouble ( ex : falling out of a plane )<br><br>the solution ( ex : makeshift black & decker helicopter )<br><br>the escape ( ex : safely driving away )<br><br>so i to keep the tone of the campaign , i decided to create still images with all three steps depicted at once . each mockup contains a story that needs to be unraveled by the viewer ; obviously a final version would have better visuals , ideally using photography .","<img src='ads/bd2.jpg'><br><br><p>if there's no way out ... make one </p><img src='ads/bd1.jpg'>");
	}
